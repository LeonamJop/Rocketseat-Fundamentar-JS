...
//Exemplo do ponto e virgula que pode ocasionar problema, raro.
(function () {
   console.log("alo");
})()

//Binário
console.log("Binário: ", number + 1);

//Unário
console.log("Unário: ", ++number);

//Ternário
console.log('Ternário: ', false ? 'alo' : 'nada'); //troque true por false
