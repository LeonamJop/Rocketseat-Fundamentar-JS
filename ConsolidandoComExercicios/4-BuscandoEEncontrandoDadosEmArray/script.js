...
//         authorsBooks.push(book.title);
//       }
//     }
//   }

//   console.log("Livros do autor: ", "Augusto Cury" ,authorsBooks );
// }
...
function authorsBooks(author) {
  ...
  for (const category of booksByCategory) {
    for (const book of category.books) {
      if(!author){
        throw new Error('Autor não identificado');
  ...
  return console.log("Livros do autor: ", author, authorsBooks);
}
